        ...
        (function () {
            ...
            */
            ...
            control_knob_object.enable = function enable() {
                if (disabled === true) {
                    disabled = false;
                    $control_knob_object.on('focus blur touchstart touchmove touchend mousewheel DOMMouseScroll mousedown mousemove mouseup click keydown keyup keypress', ckEventHandler);
                    $ck_wrap
                        .removeClass('disabled')
                        .on('focus blur touchstart touchmove touchend mousewheel DOMMouseScroll mousedown mousemove mouseup click keydown keyup keypress', ckWrapMetaControlHandler)
                        .attr('tabindex', tab_index)
            ...
            control_knob_object.disable = function disable() {
                if (disabled === false) {
                    disabled = true;
                    $control_knob_object.off('focus blur touchstart touchmove touchend mousewheel DOMMouseScroll mousedown mousemove mouseup click keydown keyup keypress', ckEventHandler);
                    if (active) {
                        $document.trigger('mouseup'); // Manually trigger the 'mouseup' event handler
                    }
                    $ck_wrap
                        .addClass('disabled')
                        .off('focus blur touchstart touchmove touchend mousewheel DOMMouseScroll mousedown mousemove mouseup click keydown keyup keypress', ckWrapMetaControlHandler)
                        .removeAttr('tabindex')
