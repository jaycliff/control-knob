            ...
            */
            ...
            function moveKnob(direction) {
                ...
                if (ctrl_active && !shift_active) {
                    console.log('ANGLE: ' + angle + ', DEG_INC: ' + degree_increment);
                    angle = Math.ceil(angle / degree_increment) * degree_increment;
                    if (angle_additive < 0) {
            ...
            control_knob_object.enable = function enable() {
                if (disabled === true) {
                    ...
                    $ck_anchor
                        ...
                        .on('mousedown touchstart mousewheel DOMMouseScroll keydown', ckAnchorEventHandler);
                }
                return control_knob_object;
            };
            control_knob_object.disable = function disable() {
                if (disabled === false) {
                    ...
                    $ck_wrap
                        ...
                        .removeAttr('tabindex');
                    $ck_anchor
                        .off('mousedown touchstart mousewheel DOMMouseScroll keydown', ckAnchorEventHandler)
